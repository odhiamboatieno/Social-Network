...
<div style="width: 900px; margin: 52px auto;">
	<ul>
		<li style="float: left;">
			...
			<div>
				<h2 style='font-size: 20px';><a href="messages.php" style="text-decoration: none; color: #06228e;">Message</a>  |  <a href="buddylist.php?u=<?php echo $first_message_uname; ?>" style="text-decoration: none; color: #828182;" >Chat(<?php echo $buddyList; ?>)</a></h2><br />
			</div>
				<?php 
			...
			$profile_picuser_to = "userdata/profile_pics/".$profile_picuser_to_db;
					...
					if (strlen($msg_body) > 50) {
						...
						if (@$_POST['setopened_' . $id . '']) {
							...
							$setopened_query = mysqli_query("UPDATE pvt_messages SET opened='yes' WHERE id='$id'");
							if ($user_from == $user) {
						...
						if ($user_from == $user) {
							...
							echo "<div style='margin-left: 65px;'><b><a href='profile.php?u=$user_to' style='text-decoration: none; font-size: 14px; font-weight: bold; color: #ef8d02;'>$msg_to_fname</a></b> <br>
							...
							echo "<div style='margin-left: 65px;'><b><a href='profile.php?u=$user_from' style='text-decoration: none; font-size: 14px; font-weight: bold; color: #ef8d02;'>$msg_by_fname</a></b> <br>
			...
			$profile_pic = "userdata/profile_pics/".$profile_pic_db;
										...
										<div style='margin: 10px;'>
											...
											<div style='margin: 0 0 0 50px;'>
												<b><a href='profile.php?u=$user_by' style='text-decoration: none;  padding-left: 0px; font-size: 14px; color: #ef8d02; font-weight: 700;' title=\"Go to $posted_by's Profile\" >$posted_by</a></b>
