...
<div style="width: 900px; margin: 52px auto;">
	<ul>
		<li style="float: left;">
			...
			<div>
				<h2 style='font-size: 20px';><a href="messages.php?u=<?php echo $first_message_uname; ?>" style="text-decoration: none; color: #828182;">Message</a>  |  <a href="buddylist.php" style="text-decoration: none; color: #06228e;" >Chat(<?php echo $buddyList; ?>)</a></h2><br />
			</div>
			...
			$profile_pic = "userdata/profile_pics/".$profile_pic_db;
										...
										<div style='margin: 10px;'>
											...
											<div style='margin: 0 0 0 50px;'>
												<b><a href='profile.php?u=$user_by' style='text-decoration: none; font-size: 14px; color: #ef8d02; font-weight: 700;' title=\"Go to $posted_by's Profile\" >$posted_by</a></b>
