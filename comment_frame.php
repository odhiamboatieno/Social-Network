		...
		if ($postby_gender_value == 2) {
			if (($posted_to == $user) || ($user_gender_value == 2)) {
				...
				<form action='comment_frame.php?id=".$getid."' method='POST' name='postComment".$getid."'>
					<input style='padding: 10px 3px; width: 83%; margin: 0 0 5px 0; resize: none; border: 1px solid #ef8d02;' name='post_body' placeholder= 'Leave your comment here!'>
