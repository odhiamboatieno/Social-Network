...
if ($emaildata) {
	...
	if ($email == "") {
		$error = "<p class='error_echo'>Please type your ShareTime email!</p>";
	}else if ($email_run >= 1) {
		...
		$error = "<p class='succes_echo'>Email successfully changed.</p>";
						// send email
						$msg = "Successfully your ShareTime email has been changed. 
						
						";
						mail($email ,"ShareTime Email Changed",$msg, "From:ShareTime <no-reply@ShareTime.com>");
...
<?php echo $error; ?>
	<ul>
		<li style="float: left;">
			<div class="settingsleftcontent">
				<ul>
					...
					<li><a href="cbinfo_update.php" style="background-color: #ef8d02; border-radius: 3px; color: #fff;">Contact and Basic Info</a></li>
		...
		<li style="float: right;">
			...
			<div class="uiaccountstyle">
				<form action="cbinfo_update.php" method="POST">
				<h2><p>Change ShareTime Email</p></h2></br>
					ShareTime Email: </br><input type="email" name="email" id="email" class="placeholder" size="43" value="<?php echo $db_email; ?>"> </br></br>
