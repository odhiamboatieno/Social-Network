		...
		<li style="float: left;">
			...
			<div class="settingsleftcontent">
				<ul>
					...
					<li><a href="account_update.php" style="background-color: #ef8d02; border-radius: 3px; color: #fff;">Account</a></li>
			...
			<div class="settingsleftcontent">
				<p style="text-align: center; padding: 10px 0px;">Odhiambo Thomas  &copy; 2019 | ShareTime</p>
			</div>
		</li>
