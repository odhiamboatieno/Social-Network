...
if ($pic != "") {
	...
	if (((@$_FILES['uploadFile']['type']=='image/jpeg') || (@$_FILES['uploadFile']['type']=='image/png') || (@$_FILES['uploadFile']['type']=='image/gif')) && (@$_FILES['uploadFile']['size'] < 5000000)) {
		...
		if (file_exists("userdata/profile_pics/$chare/".@$_FILES["uploadFile"]["name"])) {
			...
			$sqlCommand = $con,"INSERT INTO posts(body,date_added,added_by,user_posted_to,photos,newsfeedshow ) VALUES('$post', '$date_added','$added_by', '$user_posted_to', '$photos', '$newsfeedshow')";
		...
		<article>
			...
			<?php echo '<li style="float: right;">
					...
					<div >
						...
						<li><a href="photo.php?u='.$username.'" style="background-color: #cdcdcd; color: #06228e">Photo</a></li>
