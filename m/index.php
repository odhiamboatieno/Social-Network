...
if (isset($_POST['newShareTime'])) {
	header("location: composetommy.php");
}
		...
		<div class="pro_header">
			<nav class="pro_hdr_menu">
				<ul>
					...
					<li ><a href="index.php" style="color: #2AED25; font-weight: bold;">ShareTime</a></li>	
					...
					<div class="postForm">
						<form action="" method="POST">
							...
							<div style="float: right;">
								<input type="submit" name="newShareTime" value="New ShareTime" class="postSubmit" >
							</div>
