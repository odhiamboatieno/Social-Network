<?php
	$id = $row['id'];
	$body = $row['ShareTime_body'];
	$date_added = $row['date_added'];
	$added_by = $row['added_by'];
	$user_posted_to = $row['user_posted_to'];
	$sharepostid = $row['ShareTime_post'];
	...
	if (strlen($body) > 3000) {
			$body = substr($body, 0, 3000)." <a href='viewPost.php?pid=".$id."' style='text-decoration: none; color: #ef8d02;'>... read more</a>";
		}else {
			$body = $body;
			}
