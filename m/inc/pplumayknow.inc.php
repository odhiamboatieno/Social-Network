			...
			if ($count_user_to_follow == 0) {
				...
				echo "
					...
					<div style='display: flex; padding: 8px 0;'> ";
						...
						echo "<div style='margin-left: 10px;'><b><a href='profile.php?u=$user_name' style='text-decoration: none; font-size: 14px; color: #ef8d02;' title=\"Go to $user_name_f's Profile\" class='posted_by'>$user_name_f</a></b> <br><br>
