	...
	<?php
		...
		if ($pro_changed_db != $cover_pic_db ) {
			...
			$cover_pic= "userdata/profile_pics/".$cover_pic_db ;
						...
						$sharetime_defaultcover = "img/sharetime_defaultcover.png";
						$verify_id_user = $row['verify_id'];

						echo '
							<div class="user_search_result_box" >';
								if ($cover_pic_db == "") {
									echo '<div style= "background: url('.$sharetime_defaultcover.') repeat center center; height: 130px; width: 300px; border-radius: 2px; margin: -1px 0 0 -1px; background-size: cover !important; border-bottom: 1px solid #d3d6db;">';
								}else {
