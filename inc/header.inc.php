...
if (isset($_POST['gotonoti'])) {
	if ($post_noti_num > $sharetime_noti_num) {
	     header("location: notification.php");
	}else {
	     header("location: notifications.php");
	     }
	$pstopened_query = mysqli_query("UPDATE post_comments SET opened='yes' WHERE posted_to='$user'");
	$shareopened_query = mysqli_query("UPDATE ShareTime_comments SET opened='yes' WHERE ShareTime_to='$user'");
...
<div class="header">
	<div class="headerMainmenu">
		<div>
			...
			<?php
			if ($user != '') {
				echo '<li class="logo"><a href="index.php" title="Go to ShareTime Home" >ShareTime</a></li>
...
"><a href="logout.php" title="Log me out" style="font-weight: bold; margin: 3px 8px; font-size: 14px; color: #06228e;">Logout</a>
</button></form></li>';
