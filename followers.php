				...
				echo '<div>
					     <table class="friendsmenu">
							<tr>
								...
								<th style="background-color: #01093a;"><a href="followers.php?u='.$username.'"><h1>Followers </br>'.$countfollowers.'</h1></a></th>
							</tr>
						</table>
					</div>';
					if ($countfollowers == 0){
...
//check for userfrom propic delete
		...
		$pro_num = mysqli_num_rows($pro_changed);
		if ($pro_num == 0) {
			$cover_picuser_from= "img/sharetime_defaultcover.png";
		}else {
			$pro_changed_db = $get_pro_changed['photos'];
