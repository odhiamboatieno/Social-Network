	...
	while ($row = mysqli_fetch_assoc($password_query)) {
		...
		if ($oldpassword_md5 == $db_password) {
			if ($newpassword == $repear_password) {
				...
				Successfully your ShareTime password has been changed. 
						
						If it's not by you, please follow the link.
				
						http://www.ShareTime.com/confirmationPass.php?u=".$user."&code=".$confirmCode."
						
						";
						mail($db_email ,"ShareTime Password Changed",$msg, "From:ShareTime <no-reply@ShareTime.com>");
				}
			}else {
		...
		<li style="float: left;">
			<div class="settingsleftcontent">
				<ul>
					...
					<li><a href="password_update.php" style=" background-color: #ef8d02; border-radius: 3px; color: #fff;">Password</a></li>
