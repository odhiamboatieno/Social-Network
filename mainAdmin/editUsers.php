...
<div class="main">
	...
	<table class="adminmenu">
		<tr>
			<th style="background-color: #01093a;"><a href="users.php"><h1>User</h1></a></th>
	...
	<ul class="userinfo">
		<?php include ( "./inc/connect.inc.php");
			...
			if (isset($_GET['user'])) {
				$uid = $_GET['user'];
			//getting data
			$query = $con,"SELECT  * FROM users WHERE id=$uid";
		...
		<form method="POST" action="editUsers.php?user=<?php echo $id; ?>" enctype="multipart/form-data" style="padding: 22px;">
			<div>
				<table class="edituserdata" style="float: left;">
					<tr >
						<td><img src="<?php echo $profile_pic; ?>" style="height: 150px;width: 150px;border-radius: 100px;" /> <div><?php echo $fullname; ?></td>
					</tr>
				</table>
			</div>
			<div style="margin-left: 370px;">
				<table class="edituserdata">
					...
					<tr>
						<td></td>
						<td><input type="submit" name="updateinfo" style="cursor: pointer; width: 105px; background-color: blue; color: #FFF; font-weight: bold;" placeholder="Change Data" /></td>
					</tr>
				</table>
			</div>
		</form>
