...
if ($post != "") {
	...
	$sqlCommand = $con,"INSERT INTO posts VALUES('', '$post','', '$date_added','', '$added_by', '$user_posted_to', '','','', '$discription', '','','','1','$_POST[privacy]')";
	...
	if ($num == 1) {
			...
			echo '<li style="float: right;">
					...
					<div >
						...
						<li><a href="note.php?u='.$username.'" style="background-color: #cdcdcd; color: #06228e">Note</a></li>
